...
from custom_minigrid import multigrid
from custom_minigrid import register
...
class MiniGoalLastAdversarialEnv(AdversarialEnv):
    def __init__(self):
        super().__init__(
            n_clutter=7, size=6, agent_view_size=5, max_steps=50, choose_goal_last=True
        )
...
register.register(
    env_id="MultiGrid-Adversarial-v0", entry_point=module_path + ":AdversarialEnv"
)
