    ...
    def __init__(
        ...
        if self.minigrid_mode:
            ...
            self.image_obs_space = gym.spaces.Box(
                low=0, high=255, shape=obs_image_shape, dtype="uint8"
            )
        else:
            ...
            self.image_obs_space = gym.spaces.Box(
                low=0, high=255, shape=(self.n_agents,) + obs_image_shape, dtype="uint8"
            )
        ...
        if self.fully_observed:
            self.position_obs_space = gym.spaces.Box(
                low=0, high=max(width, height), shape=(self.n_agents, 2), dtype="uint8"
            )
